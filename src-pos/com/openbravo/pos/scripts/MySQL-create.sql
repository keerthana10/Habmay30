...
CREATE TABLE PRODUCTS (
    ...
    ISCOMBOPRODUCT varchar(1) NOT NULL DEFAULT 'N',
    PRIMARY KEY (ID),
...
CREATE TABLE TICKETS (
    ...
    NCCOMMENTS varchar(255) DEFAULT NULL,
    PROMODISCOUNT DOUBLE(6,2) NOT NULL DEFAULT '0',
    OFFERDISCOUNT DOUBLE(6,2) NOT NULL DEFAULT '0',
    PRIMARY KEY (ID),
...
CREATE TABLE TICKETLINES (
    ...
    PROMODISCOUNT DOUBLE(6,2) NOT NULL DEFAULT '0',
    PRICE DOUBLE NOT NULL,
    DISCOUNTPRICE DOUBLE(10,2) NOT NULL DEFAULT '0',
    PROMODISCOUNTPRICE DOUBLE(10,2) NOT NULL DEFAULT '0',
    ...
    PRODUCTIONAREA VARCHAR(60),
    PRODUCTIONAREATYPE VARCHAR(60),
    PRIMARYADDON INT(1) DEFAULT NULL,
...
CREATE TABLE CARDTYPEMASTERS (
  ID varchar(255) NOT NULL,
  CARDTYPE varchar(50) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--insert  into CARDTYPEMASTERS (ID,CARDTYPE) values ('1','AMEX'),('2','Debit Card'),('3','Others');
